  ...
  return (
    <div className="relative">
      ...
      {points.length > 0 && (
        <button
          onClick={refitBounds}
          className="absolute bottom-3 right-3 btn btn-xs btn-circle bg-base-100 shadow-md border border-base-300 hover:bg-base-200 z-[500]"
          title={t('travelMap.fitAllPins')}
        >
